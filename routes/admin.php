...
use App\Http\Controllers\Admin\PostCommentsController;
...
Route::group(['middleware' => ['auth:admin'], 'prefix' => 'admin/', 'as' => 'admin.'], function () {
    ...
    Route::group([
      ...
      Route::group([
        ...
        Route::post("/check-name",[PostsController::class,'check'])->name("check_name");
    ...
    Route::group([
      ...
      Route::get('/', [PostCommentsController::class, 'index'])->name('index');
      Route::post('edit/{id}', [PostCommentsController::class, 'edit'])->name('edit');
      Route::post('/update', [PostCommentsController::class, 'update'])->name('update');
      Route::post('/delete', [PostCommentsController::class, 'delete'])->name('delete');
  });
    //tags
    Route::group([
        'prefix' => '/tags',
