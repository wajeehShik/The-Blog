...
<div class="row">
    ...
    overflow: hidden;" action="{{route('admin.settings.update')}}" method="POST" class="text-center" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('phone') is-invalid @enderror" type="text" name="phone" value="{{ old('phone', $setting->phone)}}" placeholder="Enter full phone">
                        @error('phone')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('linked_in') is-invalid @enderror" type="text" name="linked_in" value="{{ old('linked_in', $setting->linked_in)}}" placeholder="يرجى ادخال اسم">
                        @error('linked_in')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input class="form-control @error('youtube') is-invalid @enderror" type="text" name="youtube" value="{{ old('youtube', $setting->youtube)}}" placeholder="يرجى ادخال اسم">
                        @error('youtube')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
