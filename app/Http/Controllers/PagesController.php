...
class PagesController extends Controller
{
    ...
    public function store(PagesRequest $request)
    {
        $page = Page::create([
            ...
            'value' => Purify::clean(EditorArabic::editorContent($request->post('value'),"/upload/pages/")),
    ...
    public function update(PagesRequest $request)
    {
        ...
        $data['value'] =  Purify::clean(EditorArabic::editorContent($request->post('value'),"/upload/pages/"));
        $page->update($data);
